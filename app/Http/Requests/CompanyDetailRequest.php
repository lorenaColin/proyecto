...
class CompanyDetailRequest extends FormRequest
{
    ...
    {
        return [
            'tones_incluide' => 'required|integer|max:19',
            'pac_id' => 'required|integer|max:10',
            'fechaco' => 'required|date',
            'fechaven' => 'required|date',
            'sta_prod' => 'required|enum:P,T',
    ...
    public function messages()
    {
        return [
            ...
            'private_key.file' => 'La clave privada debe ser un archivo',
